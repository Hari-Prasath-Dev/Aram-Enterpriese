                            ...
                            <form action="#">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control rounded-lg" id="name" placeholder="Enter Full Name" required>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <input type="tel" class="form-control rounded-lg" id="phone" placeholder="Enter Phone Number" required>
                                    </div>
                                    <div class="mb-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control rounded-lg" id="location" placeholder="Enter Location">
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control rounded-lg" id="nominee_name" placeholder="Enter Nominee Name" required>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <input type="tel" class="form-control rounded-lg" id="nominee_number" placeholder="Enter Nominee Phone Number" required>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <div class="flex gap-2">
                                            <input type="text" maxlength="1" id="pin-1" onkeyup="moveToNext(this, 'pin-2')" class="w-12 h-12 text-center text-xl border border-neutral-300 rounded-lg bg-white focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white">
                                            <input type="text" maxlength="1" id="pin-2" onkeyup="moveToNext(this, 'pin-3')" class="w-12 h-12 text-center text-xl border border-neutral-300 rounded-lg bg-white focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white">
                                            <input type="text" maxlength="1" id="pin-3" onkeyup="moveToNext(this, 'pin-4')" class="w-12 h-12 text-center text-xl border border-neutral-300 rounded-lg bg-white focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white">
                                            <input type="text" maxlength="1" id="pin-4" class="w-12 h-12 text-center text-xl border border-neutral-300 rounded-lg bg-white focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white">
                                        </div>
                                    </div>
                                    <div class="mb-5">
